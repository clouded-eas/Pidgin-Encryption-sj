...
void PE_unescape_name(char* origname) {
...
/* Removed from Gaim/Pidgin, so added in here :)  */
...
/* int PE_bytes_to_colonstr(unsigned char *str, unsigned char *bytes, int num) { */
...
/* /\* Note: str will _NOT_ be null terminated.  Its length will be returned */
/*    from the function *\/    */
/* int PE_bytes_to_str(unsigned char *str, unsigned char *bytes, int num) { */
/*    int bytes_cursor=0, str_cursor=0; */
...
/* int PE_nstr_to_bytes(unsigned char *bytes, unsigned char *nstr, int num) { */
...
/* int PE_cstr_to_bytes(unsigned char *bytes, unsigned char *cstr, int num) { */
/*    int bytes_cursor, str_cursor = 0; */
/*    unsigned char minibuf[3] = "00"; */
